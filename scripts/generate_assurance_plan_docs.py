...
def render() -> str:
    ...
    lines.extend(
        [
            ...
            "The named repositories above are sanitized, non-authoritative fixtures only; AWQ does "
            "not execute them or require them at runtime. Consumers own their native Android/JVM "
            "evidence and must bind it to the generic AWQ adapter contract.",
            "",
