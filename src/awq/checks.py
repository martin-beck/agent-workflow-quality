...
def guidance_resolution(root: Path, paths: list[Path], policy: dict[str, Any]) -> list[Finding]:
    """Validate contradiction, clarification and reopen state transitions."""
    del policy
    from awq.guidance_resolution import check
