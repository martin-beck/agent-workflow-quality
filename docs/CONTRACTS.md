...
| `AWQ-CONTRACT-NATIVE-BUNDLE-ASSURANCE-V2-V2` | 2 | `json-schema` | `schemas/native-bundle-assurance-v2.schema.json` | `awq.tests.native_bundle.NativeBundleTests` | [docs/NATIVE_BUNDLES.md](NATIVE_BUNDLES.md) |
