...
[Python family](docs/PYTHON_ADAPTERS.md), [shell family](docs/SHELL_ADAPTERS.md), and
[documentation family](docs/DOCUMENTATION_ADAPTERS.md). The schema-format family follows in AR-0015.
